...
static uint16_t     wp_dist = 65535; // Distance to active MISSION in meters
...
static unsigned long armed_Time = 0;                // time first armed
...
#ifdef OSD_GPS_HDOP
static float        osd_eph = 9990;                 // gps horizontal dilution of precision (HDOP)
#endif OSD_GPS_HDOP
